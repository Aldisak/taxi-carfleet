...
/// <summary>Validates the create vehicle request — checks required fields and ranges.</summary>
internal sealed class CreateVehicleValidator : Validator<CreateVehicleRequest>
{
